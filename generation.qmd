...
coastal_shares_pdf <- 
  coastal_shares_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.3: Share of Net Generation by Fuel Type, Coastal Region")
...
coastal_generation_gwh_pdf <- 
  coastal_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.4: Figure 4.4: Electricity Generation, Coastal Region")
...
railbelt_shares_pdf <- 
  railbelt_shares_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.3: Share of Net Generation by Fuel Type, Railbelt Region")
...
railbelt_generation_gwh_pdf <- 
  railbelt_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.4: Figure 4.4: Electricity Generation, Railbelt Region")
...
rural_remote_shares_pdf <- 
  rural_remote_shares_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.3: Share of Net Generation by Fuel Type, Rural Remote Region")
...
```{r, eval=knitr::is_html_output()}
#| label: fig-generation-rural-remote
...
rural_remote_generation_gwh_pdf <- 
  rural_remote_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.4: Figure 4.4: Electricity Generation, Rural Remote Region")
