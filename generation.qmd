...
coastal_generation_gwh_pdf <- 
  coastal_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.4: Electricity Generation, Coastal Region")
...
railbelt_shares_pdf <- 
  railbelt_shares_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.5: Share of Net Generation by Fuel Type, Railbelt Region")
...
railbelt_generation_gwh_pdf <- 
  railbelt_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.6: Electricity Generation, Railbelt Region")
...
rural_remote_shares_pdf <- 
  rural_remote_shares_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.7: Share of Net Generation by Fuel Type, Rural Remote Region")
...
rural_remote_generation_gwh_pdf <- 
  rural_remote_generation_gwh_plot +
  geom_col(position = position_stack(reverse = TRUE)) +
  ggtitle("Figure 4.8: Electricity Generation, Rural Remote Region")
